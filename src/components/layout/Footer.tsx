...
export function Footer() {
  return (
    <footer className="bg-black rounded-t-2xl h-auto">
      <div className="px-[40px] py-[40px]  flex flex-col  justify-between gap-4  md:flex-row text-white text-balance lg:flex-row lg:space-x-3">
        ...
        <div className="flex flex-wrap">
          <div className="flex w-full justify-end space-x-3 space-y-3 lg:flex-row lg:space-x-3  lg:space-y-0 flex-col ">
