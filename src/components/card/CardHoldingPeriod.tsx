    ...
    <Card className="p-6 space-y-4 h-auto rounded-2xl">
      ...
      <div className="flex flex-col md:flex-row justify-center md:space-x-4 space-y-4 md:space-y-0 items-baseline text-sm">
        ...
        <Card className="p-4 gap-3 h-auto rounded-2xl flex flex-wrap w-full md:w-auto ">
          ...
          <HolderPeriodTag value={latestEntry?.y2 || 0} title="6M-1Y" color="bg-[#C0DFD6]" />
          <HolderPeriodTag value={latestEntry?.y3 || 0} title="3-6M" color="bg-[#D7E5CD]" />
          <HolderPeriodTag value={latestEntry?.y4 || 0} title="1-3M" color="bg-[#F7E8C4]" />
          <HolderPeriodTag value={latestEntry?.y5 || 0} title="1W-1M" color="bg-[#F6D9B5]" />
          <HolderPeriodTag value={latestEntry?.y6 || 0} title="<1W" color="bg-[#F5CEB9]" />
          <HolderPeriodTag value={latestEntry?.y7 || 0} title="24H" color="bg-[#F8ADB6]" />
        </Card>
      </div>
